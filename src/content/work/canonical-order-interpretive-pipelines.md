...
summary: "An active manuscript on centralized AI interpretive pipelines: how retrieval, ranking, summary, and explanation layers concentrate canonical order, compress ambiguity, and snap novelty back into inherited frames."
status: "active"
visibility: "public"
featured: true
sortOrder: 10
stage: "Manuscript drafting; human validation anchor prepared"
...
publicMaterials:
  - "Project frame"
  - "Metric vocabulary"
  - "Validation anchor status"
questionnaire:
  status: "manual_distribution"
  label: "Human validation anchor"
  note: "A participant-facing validation package exists for the employment anchor: 36 Chinese and 36 English DOCX questionnaires, with four cases per participant. The anchor tests one visible domain; it is not the boundary of the project."
links:
  - label: "Contact"
    href: "/contact"
    type: "contact"
...
- donor-derived synthetic corpora and neutralized controls
- a semi-real employment / hiring / screening anchor
- model-family and backend robustness checks
