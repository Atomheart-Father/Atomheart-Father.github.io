...
Patrick Wilson's account of cognitive authority remains useful because most knowledge is second-hand. People rely on sources they regard as competent, trustworthy, or institutionally credible. Search engines have long participated in that process by making certain sources appear more relevant than others. Dervin's sense-making theory adds a second point: information seeking is not merely retrieval, but the construction of meaning under conditions of uncertainty. Users search because there is a gap to be bridged, not merely because there is an object to be fetched.
...
This is where work on transparency and accountability is especially relevant. Ananny and Crawford warn that visibility does not automatically produce accountability, because what becomes visible is itself structured by institutions and interfaces. Michael Power's account of the audit society makes a related point: verification can become ritualized. Systems may generate the appearance of accountability without creating the conditions for meaningful contestation.

In generative search, apparent transparency can therefore become part of the problem. A response with citations may look more accountable than an uncited answer, but if the citations are weakly connected to the claims, the interface can borrow legitimacy from sources it has not faithfully represented. The burden of verification is shifted back to the user, while the interface retains the benefit of appearing grounded.
...
A result page can distort such questions through ranking, but it often leaves disagreement materially visible as separate source objects. A generated answer tends to absorb disagreement into a single surface. The danger is not only that the answer may be false. It may be too coherent.
...
Research on LLM summarization and writing assistance supports this concern. Subbiah and colleagues, working with professional writers, found that models could produce coherent short-story summaries while still making faithfulness errors and struggling with specificity and difficult subtext. Agarwal, Naaman, and Vashistha show that AI writing suggestions can push users toward more generic and Westernized styles, diminishing culturally specific nuance. These findings do not mean that every generated answer erases culture. They show that fluency and efficiency can come with a standardizing pressure.
...
Here again, cognitive authority matters. When a system offers a fluent account of what a user's problem is and what options are reasonable, it supplies categories through which the user may understand themselves. This can be helpful, especially when the user lacks access to expert advice. But it can also over-format experience. Problems rooted in institutions may be translated into personal optimization. Political constraints may be redescribed as planning challenges. Cultural or existential conflicts may be rendered as productivity, mindset, or therapeutic language.
...
Generative search concentrates a crucial moment in the knowledge process: the moment when scattered materials become a first usable account. That concentration is not absolute, and it does not make users passive. But it does shift platform power from the ranking of sources toward the mediation of sensemaking.

The central question is therefore not whether AI systems should answer questions. They already do, and often they do so usefully. The question is whether the answers preserve the conditions under which users can understand, contest, and revise the synthesis they have been given.

A healthy information environment does not merely provide answers more quickly. It keeps open the path from answer back to evidence, from evidence back to disagreement, and from disagreement back to judgment. Without that path, generative search risks turning the first account of the world into a platform-managed surface: fluent, convenient, and difficult to dispute at the moment when dispute matters most.

## References

Agarwal, D., Naaman, M., & Vashistha, A. (2025). *AI Suggestions Homogenize Writing Toward Western Styles and Diminish Cultural Nuances*. Proceedings of the 2025 CHI Conference on Human Factors in Computing Systems.
...
Jaźwińska, K., & Chandrasekar, A. (2025). AI Search Has a Citation Problem. *Columbia Journalism Review / Tow Center for Digital Journalism*.

Memon, S. A., & West, J. D. (2024). Search engines post-ChatGPT: How generative artificial intelligence could make search less reliable. *arXiv:2402.11707*.
...
Poell, T., Nieborg, D., & Duffy, B. (2021). *Platforms and Cultural Production*. Polity.

Power, M. (1997). *The Audit Society: Rituals of Verification*. Oxford University Press.

Striphas, T. (2015). Algorithmic culture. *European Journal of Cultural Studies*, 18(4–5), 395–412.

Subbiah, M., Zhang, S., Chilton, L. B., & McKeown, K. (2024). Reading Subtext: Evaluating Large Language Models on Short Story Summarization with Writers. *Transactions of the Association for Computational Linguistics*, 12, 1290–1310.
