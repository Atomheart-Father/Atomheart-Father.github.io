# Chromi Kingdom 网站使用说明

这份文档用于日常维护 Chromi Kingdom。你可以先按这里的流程补内容、本地预览、检查构建，再决定是否 push 到 GitHub 自动发布。
...
```bash
cd /Users/bozhongxiao/Desktop/ChlomeeTV/论文/chromi-kingdom-site
```
