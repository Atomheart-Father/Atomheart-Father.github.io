# CHLOMEE STUDIO 网站使用说明

这份文档用于日常维护 CHLOMEE STUDIO。你可以先按这里的流程补内容、本地预览、检查构建，再决定是否 push 到 GitHub 自动发布。
...
- 部署方式：GitHub Pages
- 线上地址：https://atomheart-father.github.io/
- 仓库地址：https://github.com/Atomheart-Father/Atomheart-Father.github.io
...
8. https://atomheart-father.github.io/ 更新
```
...
```bash
cd /Users/bozhongxiao/Desktop/ChlomeeTV/论文/chlomee-studio-site
```
...
```bash
gh run list --repo Atomheart-Father/Atomheart-Father.github.io --limit 5
```

如果想等待某次部署完成：

```bash
gh run watch <run-id> --repo Atomheart-Father/Atomheart-Father.github.io --exit-status
```
...
```text
1. 打开 https://github.com/Atomheart-Father/Atomheart-Father.github.io
...
```text
https://atomheart-father.github.io/journal
```
